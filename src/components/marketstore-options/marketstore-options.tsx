    ...
    return (
        <div className="flex flex-col sm:flex-row justify-start items-start gap-2 mt-4 w-full md:mb-0 mb-4">
            {StoreMarketButtons.map((item) => {
                return (
                    <span key={item.title} className="flex flex-col lg:flex-row gap-2 items-center rounded-xl px-3 py-8 sm:py-4 cursor-text w-full xl:w-52" style={{ backgroundColor: '#F4F4F4' }}>
                        {item.icone}
